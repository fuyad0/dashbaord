@php
    ...
    $logo =
        $systemSetting && $systemSetting->logo
    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="{{ route('dashboard') }}">
                <img src="{{ $logo ?? asset('frontend/logo.png') }}" class="header-brand-img desktop-logo" alt="logo">
                <img src="{{ $logo ?? asset('frontend/logo.png') }}" class="header-brand-img toggle-logo"
                    alt="logo">
                <img src="{{ $logo ?? asset('frontend/logo.png') }}" class="header-brand-img light-logo" alt="logo">
                <img src="{{ $logo ?? asset('frontend/logo.png') }}" class="header-brand-img light-logo1"
                    alt="logo">
            </a>
        </div>
        ...
        @if(Auth::user()->role==='Admin')
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 640 640">
                            <path
                        ...
                        <span class="side-menu__label">Stores</span><i class="angle fa fa-angle-right"></i>
                    </a>

                    <ul class="slide-menu">
                        <li><a href="{{ route('store.index') }}" class="slide-item">Stores list</a></li>
                        <li><a href="{{ route('availability.index') }}" class="slide-item">Stores Availiability</a></li>
                        {{-- <li><a href="{{ route('offer.index') }}" class="slide-item"> Stores Offer</a></li> --}}
                    </ul>
                </li>
                ...
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('plan.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 640 640">
        ...
        @endif
                ...
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('review.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" class="side-menu__icon" viewBox="0 0 640 640"><path d="M341.5 45.1C337.4 37.1 329.1 32 320.1 32C311.1 32 302.8 37.1 298.7 45.1L225.1 189.3L65.2 214.7C56.3 216.1 48.9 222.4 46.1 231C43.3 239.6 45.6 249 51.9 255.4L166.3 369.9L141.1 529.8C139.7 538.7 143.4 547.7 150.7 553C158 558.3 167.6 559.1 175.7 555L320.1 481.6L464.4 555C472.4 559.1 482.1 558.3 489.4 553C496.7 547.7 500.4 538.8 499 529.8L473.7 369.9L588.1 255.4C594.5 249 596.7 239.6 593.9 231C591.1 222.4 583.8 216.1 574.8 214.7L415 189.3L341.5 45.1z"/></svg>
                ...
                <li class="slide {{ request()->is('admin/settings*') ? 'active is-expanded' : '' }}">
                    ...
                    @if(Auth::user()->role==='Admin')
                        ...
                        <li><a href="{{ route('stripe.edit') }}" class="slide-item">Stripe Settings</a></li>
                    @endif
                    </ul>
                </li>
        @if(Auth::user()->role==='Admin')
                 <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('activity.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 640 640"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M552 256L408 256C398.3 256 389.5 250.2 385.8 241.2C382.1 232.2 384.1 221.9 391 215L437.7 168.3C362.4 109.7 253.4 115 184.2 184.2C109.2 259.2 109.2 380.7 184.2 455.7C259.2 530.7 380.7 530.7 455.7 455.7C463.9 447.5 471.2 438.8 477.6 429.6C487.7 415.1 507.7 411.6 522.2 421.7C536.7 431.8 540.2 451.8 530.1 466.3C521.6 478.5 511.9 490.1 501 501C401 601 238.9 601 139 501C39.1 401 39 239 139 139C233.3 44.7 382.7 39.4 483.3 122.8L535 71C541.9 64.1 552.2 62.1 561.2 65.8C570.2 69.5 576 78.3 576 88L576 232C576 245.3 565.3 256 552 256z"/></svg>
