                ...
                <div class="card-body">
                   ...
                   @verbatim
                    <div class="text-warning">
                        ...
                        <p>Dear "{{name}}",
                        Your plan "{{plan_name}}" will expire on "{{end_date}}". </p> 
                    </div>
                    @endverbatim

                    <form method="post" action="{{ route('mailTemp.update', $data->id) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <label>Subject</label>
                            <input name="subject" class="form-control" value="{{ old('subject', $data->subject) }}" required>
                            @error('subject')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea id="summernote" name="body" class="form-control @error('body') is-invalid @enderror"
                                placeholder="">{{$data->body}}</textarea>
                            @error('body')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
