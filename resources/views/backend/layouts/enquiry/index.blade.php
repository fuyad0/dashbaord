...
@section('content')
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">Enquiry's List</h1>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                {{-- <div class="card-header border-bottom"
                    ...
                    <h3 class="card-title">Create New Enquiry</h3>
                        ...
                        <table class="table table-bordered text-nowrap border-bottom w-100" id="datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">Redemption code</th>
...
@push('scripts')
   ...
   // delete Confirm
        ...
        function deleteItem(id) {
            let url = "{{ route('enquiry.destroy', ':id') }}";
